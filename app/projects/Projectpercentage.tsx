...
type Range = "2000-2005" | "2006-2010" | "2011-2014";

type stats = { range: Range, series: Array<number> }
...
const colors_sets: string[] = ['#0284c7', '#fb7185', '#fde047', '#92400e', '#15803d', '#312e81', '#fda4af', '#1e293b', '#84cc16', '#312e81']
